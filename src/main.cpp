...
SPIClass spiLora(FSPI);     // FSPI para LoRa
...
// Sensores analógicos
SPIClass spiShared(HSPI);   // HSPI para ADC y RTD (diferentes pines)
// Adafruit_MAX31865 rtdSensor = Adafruit_MAX31865(PT100_CS_PIN, &spiShared); // Usar instancia SPI compartida

// Sensores ADS124S08
SPISettings spiAdcSettings(SPI_ADC_FREQUENCY, MSBFIRST, SPI_MODE1); // Settings para ADS124S08 (y compatibles con MAX31865)
